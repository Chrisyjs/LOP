    ...
    <div class="overflow-scroll">
      <div class="panel">
        ...
        <div class="content font-size-14">
          ...
          <div>
            1、预约时需如实<span class="color-red">填报姓名、电话、体温及其它需要申报的信息</span>，体温异常者及动态健康码非绿码者，请在家观察或遵医嘱，请勿进行预约操作。
          </div>
          <div>
            2、进堂前请提前打开<span class="color-red">健康码及预约码</span>信息界面，提高检入效率。请主动配合侍奉同工进行体温检测和验码工作。
          </div>
          <div>
            3、检入口支持市民卡健康码查验，不能提供杭州动态健康码信徒，可使用市民卡刷卡验码。请提前让家人或朋友在支付宝的健康码中代办健康码。无法提供健康码信息的一律不予进堂。
          </div>
          <div>4、在堂期间须全程<span class="color-red">佩戴口罩</span>。</div>
          <div>
